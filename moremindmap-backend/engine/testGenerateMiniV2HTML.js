...
async function runTest() {
  ...
  const completeData = {
    ...
    primary_driver_icon: "⚡",
    primary_driver_text_box: "Rapidly identifies high-value signals, prioritizes what matters most, and moves the system forward with decisive momentum.",
    ...
    secondary_stabilizer_text_box: "Adds structure, discipline, and reliability. Extends the operating range by protecting quality and long-term consistency.",
    opposing_pattern_1_name: "Signal",
    opposing_pattern_1_code: "S-",
    opposing_pattern_1_icon: "⊗",
    opposing_pattern_1_text_box: "Relational nuance and intuitive sensing may receive less attention under pressure, especially when speed and clarity dominate.",
    opposing_pattern_2_name: "Flex",
    opposing_pattern_2_code: "F-",
    opposing_pattern_2_icon: "↻",
    opposing_pattern_2_text_box: "Adaptability and fluidity may narrow when the system over-prioritizes structure, certainty, or fast execution.",
